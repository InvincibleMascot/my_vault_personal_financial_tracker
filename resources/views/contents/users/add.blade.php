                ...
                <div class="card-body">
                    ...
                    <form id="user_form">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="user_type_id" id="user_type_id" class="form-select" required>
                                    ...
                                    @foreach ($userTypes as $userType)
                                        <option value="{{ $userType->id }}">{{ ucwords(str_replace('_', ' ', $userType->user_type)) }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mt-4 text-end">
                            <button type="submit" class="btn btn-primary" id="save_user_btn">Save</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            $('#user_form').on('submit', function (event) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        showUsersAlert('success', res.message || 'User added successfully.');
                        setTimeout(function () {
                    ...
                    complete: function () {
                        $('#save_user_btn').prop('disabled', false).text('Save');
                    }
                });
            });
        });
